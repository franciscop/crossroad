...
declare const _default$6: ({
  ...
  url: baseUrl,
  children,
}: RouterProps) => React__default.JSX.Element;
export default _default$6;

declare type ExtractParams<T extends string> =
...
declare type InferParamsFromPath<T extends string> =
...
declare type ParseParamType<T extends string> =
...
declare type RouteType = <P extends string = string>(
  props: RouteProps<InferParamsFromPath<P>> & {
    path?: P;
  },
) => React__default.ReactNode;

declare type SetHash = (
  hash: string | HashUpdater,
  opts?: SetUrlOptions,
) => void;

declare type SetPath = (
  path: string | PathUpdater,
  opts?: SetUrlOptions,
) => void;

declare type SetQuery = (
  newQuery: Query | string | QueryUpdater,
  opts?: SetUrlOptions,
) => void;

declare type SetQueryProp = (
